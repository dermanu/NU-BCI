%% Validation of the SVM used for 3- to 4-month-old infants.

close all
load('1st_Train_LoomRand.mat');
...
for j = 1:size(table2array(predictors),1)
...
validationAccuracy2 = a/size(table2array(predictors),1)
...
caxis([-500 500])
saveas(4,'1st_Amp_5_true_loom.jpeg')
...
title(hcb,'Amplitude in \muV', 'Rotation',270, 'FontSize', 10, 'Position', [43,130,0])
caxis([-500 500])
saveas(5,'1st_Amp_5_false_loom.jpeg')
...
title(hcb,'Amplitude in \muV', 'Rotation',270, 'FontSize', 10, 'Position', [43,130,0])
caxis([-500 500])
saveas(6,'1st_Amp_5_true_random.jpeg')
...
title(hcb,'Amplitude in \muV', 'Rotation',270, 'FontSize', 10, 'Position', [43,130,0])
caxis([-500 500])
saveas(7,'1st_Amp_5_false_random.jpeg')
